...
namespace sub
{
	void PlayerOptionsMenu()
	{
		...
		AddToggle("Godmode", playerInvincibility, null, invincibilityOff);
		...
		AddLocal("Superman Punch", SmashAbility::g_smashAbility.Enabled(), SmashAbility::ToggleOnOff, SmashAbility::ToggleOnOff);
